...
const Testimonial = () => {
  ...
  const data = [
    {
      image: "/image1.jpeg",
      heading: "Exceptional Service and Delicious Food!",
      detail:
        "We hired this catering service for our wedding, and they exceeded every expectation! The food was delicious, beautifully presented, and served with such warmth. Our guests couldn’t stop raving about the appetizers and main course. Highly recommend them for any event!",
      name: "Anil",
    },
    {
      image: "/image2.jpeg",
      heading: "Fantastic Attention to Detail!",
      detail:
        "From the planning stages to the actual event, they were professional, organized, and attentive to every detail. The team made sure everything ran smoothly, and the food was outstanding. The desserts were a particular hit! I will definitely use their services again.",
    ...
    },
    {
      ...
      detail:
        "This catering team helped make our event memorable. They took care of everything with such ease, leaving us free to enjoy our time with friends and family. The variety of dishes and flavors was impressive, and everyone found something they loved. Truly a five-star experience!",
      name: "Aman",
    },
    {
      image: "/image4.jpeg",
      heading: "Top-Notch Quality and Service!",
      detail:
        "We recently hired them for a corporate event, and they delivered beyond expectations. The staff was courteous, the setup was elegant, and the food was simply amazing. They really understand how to make an event special. We’re looking forward to our next event with them!",
      name: "Adwika",
    },
  ];
  return (
      ...
      <section className="pb-10 pt-10 dark:bg-dark lg:pb-[50px] lg:pt-[50px] p-4">
        <div className="container mx-auto">
          <Swiper slidesPerView={1} ref={sliderRef}>
            ...
            <div className="relative left-0 right-0 z-10 flex items-center justify-center gap-5 sm:bottom-0">
      ...
      <div className="relative w-full pb-16 md:w-11/12 lg:w-10/12 xl:w-8/12">
        <div className="w-full items-center md:flex">
          ...
          <div className="w-full">
            <div>
              <p className="mb-0 text-base font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[22px]">
                {headings}
              </p>
              <p className="mb-11 text-base font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[16px]">
                {details}
              </p>
